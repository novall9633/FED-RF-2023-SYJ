...
cbx.on('mousemove touchmove',e=>{
    ...
    // changedTouches[0].pageX - 모바일용 x축위치값
...
const rotateCar = dir => { //dir 방향
    ...
    if(dir){
        ...
        // dir -> 0 이면 오른쪽에서 왼쪽 드래그 : 역방향
        // -> 사진번호가 감소
        // 2. 이미지 순번 감소
        fnum--;
        if(fnum == -1) fnum = 49;
        // 첫순번은 0이므로 -1이므로 마지막순번 49번으로 변경
    }//// else //////
    console.log("순번",fnum);
