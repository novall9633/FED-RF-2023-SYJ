...
$(() => {
    ...
    // 트랜지션 시간설정변수
    const TRS_TIME_DT = ".3s ease-out";
    const TRS_TIME_MOB = ".8s ease-out";
    ...
    $(window).resize(() => {
        ...
        console.log("마지막 업데이트 한계값 : ", lastPoint);

        // 트랜지션 모바일/DT 크기 체크 전환
        target.css({transition:winW<500?TRS_TIME_MOB:TRS_TIME_DT});
    
    }); ////////resize //////////
    // ->>> 트랜지션 모바일/DT 크기일 때 전환하기
