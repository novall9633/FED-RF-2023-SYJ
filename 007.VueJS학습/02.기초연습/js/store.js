...
export default new Vuex.Store({
    ...
    state:{
        ...
        cityData:{
            ...
            "광주":{
                이미지:`https://encrypted-tbn1.gstatic.com/licensed-image?q=tbn:ANd9GcTlfxLPLG7Mk3ZDIii12kz3ORhs9QGEjNvRUpOK2cDiBrC5KdBLKQVV9t5cWpQc4C2eXhhOXuqpN1raD4ER49xlGV6J0lKLI2PreAb3ww`,
                설명:`광주광역시(光州廣域市)는 대한민국의 남서부에 있는 광역시이다. 남동쪽으로 전라남도 화순군, 북동쪽으로 전라남도 담양군, 서쪽으로 전라남도 함평군, 서남쪽으로 전라남도 나주시, 북쪽으로 전라남도 장성군과 접한다. 시청 소재지는 서구 치평동이고, 행정 구역은 5구 95동이다. 광주 학생 항일 운동과 5·18 광주 민주화 운동이 발생한 지역이다. 전남대학교, 조선대학교, 광주과학기술원 등 고등 교육기관이 있다. 2년마다 광주 비엔날레가 열리고, 아시아문화중심도시 조성 사업이 국책으로 진행됐다.`
            },
            "제주":{
        ...
        imgSrc : '',
        // 도시설명 정보 셋업변수 : 화면에 반영될 설명
        desc: '',


    },
    // (2) 데이터 변경 메서드 구역
    // ->호출시 commit() 사용 -> 컴포넌트에서 호출시
    mutations:{
        // 초기 데이터 셋업 메서드
        initSet(헐,파람){
            // 전달변수는 두번째 변수 '파람'임
