...
export function Board() {
    ...
    // C - 글쓰기 / R - 글읽기 / U - 글 수정 / D - 글삭제(U에 포함)
    // 상태추가 : L - 글목록
    // 전체 5가지 상태값 : CRUD+L
   ...
   const chgList = (e) => {
    ...
    setPgNum(currNum);
    // 바인드 리스트 호출 불필요! 왜? pgNum을 bindList()에서 사용하기 때문에 리랜더링이 자동으로 일어남
   }; //////////////////////////chgList 함수 /////////////
