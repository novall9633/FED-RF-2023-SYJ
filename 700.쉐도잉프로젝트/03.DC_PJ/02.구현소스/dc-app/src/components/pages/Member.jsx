...
export function Member() {
    ...
    const changeUserId = (e) => {
        ...
        // 3. 에러아님 상태 if문
        // 조건 : 유효성 검사 결과가 true인가? 에러상태가 아니면 false
    ...
    // [ 전체 유효성 검사 체크 함수 ] ////////////////////////
    const totalValid = () => {
        // 1. 모든 상태변수 빈값일 때 에러상태값 업데이트(상태변수 검사)-> 입력 전 상태는 false
        // -> 빈값일 경우 에러처리함
    ...
    const onSubmit = (e) => {
        ...
        if (totalValid()) {
            ...
            // 6. 버튼 텍스트 변경
            document.querySelector(".sbtn").innerText = "넌 회원된거야~!";

            // 7. 페이지 이동 : 로그인페이지로
            setTimeout(() => myCon.chgPage("login", {}), 1000);
        } /////////if //////////////////
        // 3. 불통과시
        else {
