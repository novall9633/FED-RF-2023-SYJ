...
// 폰트어썸 불러오기
import { faCirclePlay, faSearch } from "@fortawesome/free-regular-svg-icons";
            ...
            <SwiperSlide key={i}>
              ...
              <section className="sw-inbox" onClick={()=>showVid(v.vsrc,v.tit)}>
                ...
                <div className="vid-img" >
                  ...
                  {/* 폰트어썸 아이콘 */}
                  <FontAwesomeIcon icon={faCirclePlay} style={{position:'absolute',bottom:'55%',left:'10%',color:'#fff',fontSize:'50px'}} />
                </div>
                {/* 동영상타이틀 박스 */}
