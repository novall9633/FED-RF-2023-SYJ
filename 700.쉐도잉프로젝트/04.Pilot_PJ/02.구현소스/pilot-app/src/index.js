...
function App() {
    ...
    *****************************************************/
    ...
    // 리턴코드 //////////////////////////
    return (
        <pCon.Provider value={{ pgName, chgPgName, flag, setCsts, transData, setTransData, gMode, setGMode, gInit }}>
            <TopArea cat={pgName} />
