...
// 원래 제이슨파일과 같은 데이터 파일을 불러올 떄는
// 데이터 파일을 다 불러온 후 그 데이터를 이용하는 코드가 실행될 수 있도록 하는 비동기코딩방식인 Promise를 사용하는 것이 원칙이다

// console.log(dFn,langCode);

// 1. 다국어 요구사항
// - 언어 선택박스를 변경하면 해당 코드에 맞게 다국어 데이터를
