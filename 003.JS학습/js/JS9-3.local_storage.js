...
dFn.qsa('.local ol li').forEach((ele,idx)=>{
    ...
    ele.onclick = function(){
        ...
        window.localStorage.removeItem(keyName[idx]);
    }; /////////click /////////////
}); ////////////////// forEach //////////////
...
dFn.qsa('.session ol li').forEach((ele,idx)=>{
    ...
    ele.onclick = function(){
        // 개별 세션스토리지 키 삭제
        console.log('삭제할 키: ',keyName[idx]);
        window.sessionStorage.removeItem(keyName[idx]);
    }; /////////click /////////////
}); ////////////////// forEach //////////////
...
function sessionSFn(){
    ...
    if(btxt == '처음'){
        ...
        // 만약 값이 셋팅 안됐으면 null값이 나옴
        // 세션 스토리지 셋팅 : sessionStorage.setItem(키명,값);
