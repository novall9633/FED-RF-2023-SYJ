...
/*************************************************** 
    ...
    -> 주의 : 숫자를 비교해도 문자열로 비교하기 때문에 "25"와 "100" 중 큰 숫자는 100이지만 25를 더 큰 데이터로 인식한다 -> sort() 메서드 비교함수로 처리
...
// 문자값 배열
const arrString = ["파", "타", "하", "가", "바", "사", "다", "라", "차", "A", "%", "a", "美"];

// sort()는 기본문자로 처리하므로 숫자는 내부함수로 빼기연산처리함
// console.log('숫자배열:',arrNumber);
// console.log('숫자배열 sort정렬:',arrNumber.sort());
// console.log('숫자배열 reverse정렬:',arrNumber.reverse());
// console.log('숫자배열 sort정렬2:',arrNumber.sort((x,y)=>x-y));
// console.log('숫자배열 reverse정렬2:',arrNumber.reverse((x,y)=>x-y));
// console.log('숫자배열 reverse정렬3:',arrNumber.sort((x,y)=>y-x));
// console.log('문자배열:',arrString);
// console.log('문자배열 sort정렬:',arrString.sort());
// console.log('문자배열 reverse정렬:',arrString.reverse());
...
// 최초출력
showScreen();
// (3) 정렬 기준에 선택박스 변경 이벤트 발생 시 
// 정렬 변경하기 (오름차순/내림차순)
// (3-1) 대상 : #sel
const selBox = dFn.qs('#sel');
// (3-2) 이벤트 연결하기 : 이벤트 종류는 change
...
// console.log(myKey);
// console.log("정렬:",myKey.reverse());

// 2단계 : 키배열을 객체의 값으로 대체하여 원하는 값 배열을 만든다.
