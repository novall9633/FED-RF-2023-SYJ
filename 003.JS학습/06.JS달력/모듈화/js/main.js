...
calBox.mouseenter(function(){
    ...
    $(this).find('.date').click(()=>{
        ...
        // 달력 인스턴스 생성시 노출된 속성/메서드중
        // addZero() - 한자리 숫자앞에 0추가 기능
        // week[] - 한글 요일변환 배열
        // 를 생성된 인스턴스 dc2로부터 얻을 수 있다

        myData = myData.split('/');
        myData = myData[0]+'년 '+dc2.addZero(myData[1]) +'월 '+dc2.addZero(myData[2])+
        '일 (' + dc2.week[myData[3]]+'요일)'
