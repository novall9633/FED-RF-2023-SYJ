...
function MainComponent() {
    ...
    return (
        ...
        // 4. 이것을 하위컴포넌트에서는 useContext(생성 컨텍스트명)으로 
        ...
        */ 
        <catContext.Provider value={{chgCat}}>
            {/* 1. 상단영역 */}
            <TopArea />
            {/* <TopArea chgItem={chgCat} /> props function down */}
            {/* 2. 메인영역 */}
