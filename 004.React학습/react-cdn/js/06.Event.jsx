...
function EventShow(){
    ...
    const getFerrari =() =>{
        ...
        // 페라리 이미지 넣기
        // 대상 : #ferrari
        ReactDOM.render(<MakeImg isrc="https://www.pngplay.com/wp-content/uploads/13/Ferrari-458-Transparent-PNG.png" ialt="페라리레드" info="true" idnm="car" tit="클릭화면 시운전해요!" />,document.querySelector('#ferrari'));
    }; ///////////////getFerrari 함수 ///////////////////
    ...
    return(
        <React.Fragment>
            ...
            <br />
            <button onClick={getFerrari}>소원 빌기 페라리주세요!</button>
        </React.Fragment>
    );
} /////////EventShow 컴포넌트 ////////////////
...
function MakeImg(props){ // isrc = 이미지경로, ialt = 이미지설명
    ...
    // true이면 페라리용 이미지 태그로 생성함
    console.log('구분속성 props.info:',props.info);
    return(
        props.info?
        <img src={props.isrc} alt={props.ialt} id={props.idnm} title={props.tit} onClick={moveCar} /> :
