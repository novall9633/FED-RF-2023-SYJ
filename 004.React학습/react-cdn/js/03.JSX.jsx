...
// (1) JSX를 사용한 예 ///////
// (1-1) 넣을 요소 만들기
const myEle1 = <h1>1. 나는 JSX를 사용하고 있어</h1>;
...
const myEle2 = React.createElement("h1",{},"2. 나는 JSX를 쓰지않아");
...
// 3. JSX 표현식 사용하기 ///////////////
const myEle3 = <h1>3. 리액트는 {num1*num2}번 사용해도 좋다</h1>
// 세번째에 출력하기 ////////
...
const myEle5 = (
    <React.Fragment>
        <h2>5. [ 배우 리스트 ]</h2>
        <ul>
            {mydata.map((val)=> <li>{val.name} : {val.movie} : {val.idx==3?"예뻐":"멋져"}</li>)}
        </ul>
    </React.Fragment>
);
// 다섯번째에 출력하기 ////////
